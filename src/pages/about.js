    ...
    <Layout>
      ...
      <div className="m-12 mx-auto w-11/12 md:w-3/4 lg:w-3/5">
        ...
        <div className="mx-auto w-11/12 md:w-3/4 lg:w-3/5 my-8">
          ...
          <h2 className="my-8">What I Believe</h2>
          <p>
          ...
          <h2 className="my-8">What People Say About Me</h2>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-4 md:gap-16 mx-auto w-11/12">
        <div>
          <blockquote>
