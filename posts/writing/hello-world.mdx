...
<aside className="p-4 bg-red-200 dark:bg-green-200 text-text text-base text-center font-worksans">Note: This post is out of date and references an earlier version of this site.</aside>
